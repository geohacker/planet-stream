...
function AugmentedDiffStream (opts) {
  ...
  var state_url = opts.state_url || 'http://overpass-api.de/api/augmented_diff_status';
  var adiff_url = opts.adiff_url;
  if (!adiff_url) {
    var base_url = opts.overpass_url || 'http://overpass-api.de/api/interpreter';
  }
